...
func TestListaVacia(t *testing.T) {
	...
	require.PanicsWithValue(t, "No hay elementos para borrar", func() { lista_Enlazada.BorrarPrimero() }, "No emite error al Borrar el primer elemento.")
	require.PanicsWithValue(t, "No hay elementos para borrar", func() { iteradorDeLista.Borrar() }, "No emite error al Borrar algun elemento.")
